...
Panmind is long gone, and all the GitHub repos (ssl_helper, bigbro, recaptcha, zendesk, jquery-ajax-nav) are dead links. The Rails plugin ecosystem described here was replaced by gems and engines.
{{< /retrospective >}}

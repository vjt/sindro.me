...
Azzurra è nata da un litigio. Uno scazzo violento su [`#roxybar`](https://web.archive.org/web/19980705193028/http://www.roxybar.it:80/download/chat.html) — un canale su [IRCnet](https://it.wikipedia.org/wiki/IRCnet), la principale rete IRC europea — che portò all'espulsione dei futuri fondatori. Non se ne andarono solo dal canale. Se ne andarono dalla rete intera e ne fondarono una propria. Ma i primi MOTD dei server portavano il rancore: *"non si accettano carote."*

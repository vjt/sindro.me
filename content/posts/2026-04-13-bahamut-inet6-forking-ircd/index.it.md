...
Dopo il mio [ultimo commit](https://github.com/vjt/bahamut-inet6/commit/bab2033) del 5 dicembre 2002, il repository rimase silenzioso per tre anni. Io ero passato a [scrivere services](/it/posts/2026-04-14-suxserv-irc-services-archaeology/), poi la vita è successa — il lavoro, la lenta deriva dalla rete.
...
Dopo i contributi di monas, la codebase è passata per diverse mani. [Matteo Panella](https://github.com/azzurra/bahamut/commits?author=rfc1459) (morpheus) l'ha portata avanti dal 2008 al 2012 con 104 commit — il contributore più pesante dopo gli autori originali. Ha aggiunto il mode halfop, il supporto HAProxy, il branch 4.7, e ha iniziato a fixare le assunzioni 64-bit che erano incrostate nel codice originale. Poi il repo è rimasto dormiente per otto anni.

Nel 2020, una rinascita: [Paolo Iannelli](https://github.com/azzurra/bahamut/commits?author=piannelli) ha modernizzato SSL per Debian 10, [Alessio Bonforti](https://github.com/azzurra/bahamut/commits?author=abonforti) ha fixato la gestione della catena dei certificati, e [Michele "Sonic" Vacca](https://github.com/azzurra/bahamut/commits?author=Essency) ha aggiornato il supporto OpenSSL oltre la 1.1. Poi a marzo 2026 — settimane prima che iniziassi a scrivere questo post — Sonic ha pushato una raffica di commit per far compilare la codebase nativamente in modalità 64-bit su GCC 13 e OpenSSL 3.x. Il flag `-m32` è finalmente sparito.
...
Ma forkare e estendere il server IRC di qualcun altro non bastava. Ho anche iniziato a costruire IRC services da zero. Quella è la [prossima storia](/it/posts/2026-04-14-suxserv-irc-services-archaeology/) — 954 commit, un demone C multithreaded, e il progetto che non ho mai finito. Continuate a leggere.

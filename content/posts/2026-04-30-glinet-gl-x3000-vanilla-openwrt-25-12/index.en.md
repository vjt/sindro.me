...
also what you flash for in-place upgrades — you stay on stock U-Boot, you
keep using sysupgrade bins forever.
...
surprise 5G outage costs in a meeting that matters. Vanilla OpenWrt
gives me the surface I need to write my own reconnect logic — detect the
outage, wait for 5G to restore, flip back automatically — instead of
fighting GL.iNet's fork. I haven't written it yet. But now I *can*.

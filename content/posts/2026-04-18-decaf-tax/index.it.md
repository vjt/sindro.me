...
- **Quadro RT** — plusvalenze al 26% sui titoli. Decaf si fida del profitto o perdita dichiarato dal broker: il broker tiene traccia di ogni lotto (data di acquisto, prezzo, quantità) e su ogni vendita sa di preciso quale lotto hai ceduto e a quale costo. Non ha senso ricalcolarlo. Decaf prende quel numero, lo converte in EUR al cambio BCE della data di operazione, e lo trascrive in riga RT. Codice in [`quadro_rt.py`](https://github.com/vjt/decaf/blob/master/src/decaf/quadro_rt.py).

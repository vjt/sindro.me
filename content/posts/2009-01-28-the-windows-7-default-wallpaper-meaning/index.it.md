...
Quando installi la [beta per sviluppatori di Windows
7](http://www.microsoft.com/windows/windows-7/beta-download.aspx), dopo il
solito ciclo di 3 riavvii, vieni accolto dalla seguente immagine:
...
È il [pesce combattente del Siam](http://en.wikipedia.org/wiki/Betta_fish), un

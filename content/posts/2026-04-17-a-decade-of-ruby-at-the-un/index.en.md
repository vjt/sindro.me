...
After several years on the agile team, I crossed into the enterprise side of IFAD's IT as tech lead on a large finance project built on IBM technology. I won't say much about the project itself — most of the work sits under the kind of constraints where "can't say much" is the right answer — but I can say who I worked with, and what I learned.

I reported to [Simone Giorgi](https://www.linkedin.com/in/simone-giorgi-2a811a/), with [Thomas Bousios](https://www.linkedin.com/in/thomas-bousios-b49760/) one level up as the director of the area. I owe both of them a debt. They trusted me in a context where my background — an agile-team consultant from the Rails floor — was hardly an obvious fit for an IBM-based enterprise programme under tight governance. The constraints were hard: slower cycles, more risk scaffolding, narrower room to improvise. I'm an agile person by nature, and this was a different sport. Simone and Thomas gave me space to learn it while doing the job, and — more than once — protected me when I tried to take on too many things at once. I learned from them how to stay inside the lines and still ship. That's a skill I didn't have when I walked in, and I use it every day now.

The business analyst on the project was [Michelle Lockwood](https://www.linkedin.com/in/michelle-lockwood-8929a55/), and Michelle was instrumental to its outcome — the same way Victoria and Shamela had been instrumental on Members. Good enterprise software happens when engineering and business analysis are done with the same care, by people who argue the hard questions out between themselves rather than through the org chart. Michelle is among the best I've worked with.

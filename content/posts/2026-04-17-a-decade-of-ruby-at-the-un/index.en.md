...
I reported to [Simone Giorgi](https://www.linkedin.com/in/simone-giorgi-2a811a/), with [Thomas Bousios](https://www.linkedin.com/in/thomas-bousios-b49760/) one level up as the director of the area. They picked me because years of shipping on the agile side had earned it: Members, the back-office rewrite, the JSON bus, the Rails apps on top, and the Ansible playbooks, deployment plumbing, and ops tooling underneath. Knowing both sides — software engineering and the infrastructure it runs on — was what the role needed.

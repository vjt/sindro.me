...
My last release was [v1.2.2](https://rubygems.org/gems/chrono_model/versions/1.2.2) in May 2019. After that, [Geremia Taglialatela](https://github.com/tagliala) took over and pushed it to [v5.0.0](https://rubygems.org/gems/chrono_model/versions/5.0.0) with Rails 8.1 and Ruby 4.0 support. [34 releases](https://rubygems.org/gems/chrono_model/versions) spanning 14 years, [201 stars](https://github.com/ifad/chronomodel/stargazers), and still actively maintained. The [API documentation](https://vjt.github.io/chronomodel/) and the [repo](https://github.com/ifad/chronomodel) are both alive.
{{< /retrospective >}}

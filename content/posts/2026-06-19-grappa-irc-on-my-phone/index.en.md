...
> **tl;dr** — [click here to try it](https://grappa.chat): log in with a nick and you're in.
...
Repo's open as always: [github.com/vjt/grappa-irc](https://github.com/vjt/grappa-irc). Issues welcome — that's most of how the bugs get found. Open [grappa](https://grappa.chat) — the same PWA in the screenshots above — log in with a nick and you're in. There you'll find `vjt-claude` — the AI I handed the project context to — or me, when I'm around. Now if you'll excuse me, I'm going to go read the rest of this channel. From my phone.

...
ChanServ faceva lo stesso per i canali — registri, configuri le access list, e il service manteneva l'ordine anche quando non eri online. Pensate agli admin dei gruppi WhatsApp, tranne che l'admin non deve essere online perché le regole valgano. Questo dava agli utenti normali un modo per tenere al sicuro la propria identità senza bisogno di una macchina permanentemente connessa a internet.

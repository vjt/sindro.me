...
ChanServ did the same for channels — register, set up access lists, and the service would maintain order even when you weren't online. Think WhatsApp group admins, except the admin doesn't need to be online for the rules to hold. This gave normal users a way to keep their identity safe without needing a machine permanently connected to the internet.

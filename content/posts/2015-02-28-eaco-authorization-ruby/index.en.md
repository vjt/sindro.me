...
Scriptoria is an internal workflow application at [IFAD](http://www.ifad.org/) — a UN specialized agency in Rome — and its authorization layer has been annoying me for months. The code works, but it's tangled into the app. Every time we need to add a new role or change who can access what, we're editing application code that shouldn't care about authorization semantics.
